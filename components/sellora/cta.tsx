  ...
  return (
    <section className="px-12 py-20 max-sm:px-5">
      <div className="max-w-170 mx-auto relative overflow-hidden bg-[linear-gradient(135deg,rgba(124,58,237,0.2),rgba(219,39,119,0.14))] border border-[rgba(124,58,237,0.28)] rounded-[20px] px-12 py-15 text-center max-sm:px-6 max-sm:py-9">
        ...
        <p className="relative text-[15px] text-[#94a3b8] leading-[1.75] mb-8 max-w-115 mx-auto">
        ...
        <div className="relative flex gap-3 justify-center flex-wrap">
          <button className="inline-flex items-center gap-1.5 px-7 py-3.5 rounded-[10px] text-[15px] font-medium text-white bg-linear-to-br from-[#7c3aed] to-[#db2777] hover:opacity-90 active:scale-[0.97] transition-all duration-200 cursor-pointer">
            Create your store free <span aria-hidden="true">→</span>
          </button>
          <button className="inline-flex items-center gap-1.5 px-7 py-3.5 rounded-[10px] text-[15px] font-medium text-[#E5E7EB] bg-transparent border border-white/[0.14] hover:bg-white/5 active:scale-[0.97] transition-all duration-200 cursor-pointer">
            See a live demo
          </button>
        </div>
      </div>
